import mlflow
import os
from src.module.ingest_data import (
    fetch_housing_data,
    preprocess_dataset,
    load_housing_data,
    split_dataset,
...
from src.module.train import build_and_train_model
from src.module.score import make_predictions
...
with mlflow.start_run(run_name="Predict Housing Prices") as parent_run:
    ...
    predictions_run_id = make_predictions(
        datasets_path_for_prediction, model_path_for_prediction, predictions_output_path
    )
